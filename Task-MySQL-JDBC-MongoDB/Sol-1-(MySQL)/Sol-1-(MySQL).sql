CREATE DATABASE JFSD_MySQL;

Use JFSD_MySQL;

/* 1. Create the Empl Table */
CREATE TABLE Empl (
...
/* 2. Insert Data into the Empl Table */
...
/* E1. Write a query to display the name of an employee whose name contains "A" as third alphabet? */
SELECT ename FROM Empl WHERE ename LIKE '__A%';

/* E2. Write a query to display the name of an employee whose name contains "A" as Second alphabet? */
SELECT ename FROM Empl WHERE ename LIKE '_A%';

/* F1. Write a query to display the name of an employee whose name contains "T" as the last alphabet? */
SELECT ename FROM Empl WHERE ename LIKE '%T';

/* F2. Write a query to display the name of an employee whose name contains "H" as the last alphabet? */
